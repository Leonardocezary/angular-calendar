...
/**
 * Shows all events on a given period(eg, 14). Example usage:
 *
 * ```typescript
...
@Component({
  selector: 'mwl-calendar-scheduler',
  templateUrl: './calender-scheduler-view.component.html',
  styleUrls: ['./calender-scheduler-view.component.scss']
})
export class CalenderSchedulerViewComponent
